...
module Espago
  module Payment
    class PaymentResponseHandler
      ...
      sig { params(payment: ::Payment, response: Response).returns([Symbol, String]) }
      ...
      def self.handle_failure(payment, state)
        ...
        awaiting_states = %w[timeout connection_failed ssl_error parsing_error unknown_faraday_error unexpected_error]
