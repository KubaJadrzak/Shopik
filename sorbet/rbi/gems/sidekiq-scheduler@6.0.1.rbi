...
class SidekiqScheduler::Scheduler
  ...
  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#259
  def inspect; end
  ...
  #
  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#320
  ...
  # @return [Boolean]
  #
  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#336
  def enabled_queue?(job_queue, queues); end

  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#368
  def handle_errors; end

  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#267
  ...
  #
  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#295
  def schedule_state(name); end

  # Returns the value of attribute scheduler_config.
  #
  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#265
  def scheduler_config; end
  ...
  #
  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#305
  def set_schedule_state(name, state); end

  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#283
...
class SidekiqScheduler::SidekiqAdapter
  class << self
    ...
    # @return [Boolean]
    #
    # source://sidekiq-scheduler//lib/sidekiq-scheduler/sidekiq_adapter.rb#29
    def redis_key_exists?(key_name); end

    # source://sidekiq-scheduler//lib/sidekiq-scheduler/sidekiq_adapter.rb#35
    ...
    # source://sidekiq-scheduler//lib/sidekiq-scheduler/sidekiq_adapter.rb#12
    def start_schedule_manager(sidekiq_config:, schedule_manager:); end

    # source://sidekiq-scheduler//lib/sidekiq-scheduler/sidekiq_adapter.rb#17
    def stop_schedule_manager(sidekiq_config:); end
  end
end

# source://sidekiq-scheduler//lib/sidekiq-scheduler/sidekiq_adapter.rb#3
SidekiqScheduler::SidekiqAdapter::SIDEKIQ_GTE_7_3_0 = T.let(T.unsafe(nil), TrueClass)

# source://sidekiq-scheduler//lib/sidekiq-scheduler/sidekiq_adapter.rb#4
SidekiqScheduler::SidekiqAdapter::SIDEKIQ_GTE_8_0_0 = T.let(T.unsafe(nil), TrueClass)
...
module SidekiqScheduler::Utils
  class << self
    ...
    #
    # @param klass [Class] the class to check is descendant from ActiveJob
    # @return [Boolean]
    #
